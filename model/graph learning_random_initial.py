...
class QNet_Agent(object):
    ...
    def store_model(self):
        torch.save(self.nn.state_dict(), './results/random initial/RL learning with random.pt')
...
save_file('./results/random initial/resilience curve with random.pkl', final)
save_file('./results/random initial/repaire sequence with random.pkl', final_inspected_list)
